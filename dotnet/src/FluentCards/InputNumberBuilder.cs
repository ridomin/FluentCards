...
public class InputNumberBuilder
{
    ...
    /// <returns>The builder instance for method chaining.</returns>
    public InputNumberBuilder WithLabelPosition(InputLabelPosition position)
    {
    ...
    /// <returns>The builder instance for method chaining.</returns>
    public InputNumberBuilder WithLabelWidth(string width)
    {
    ...
    /// <returns>The builder instance for method chaining.</returns>
    public InputNumberBuilder WithInputStyle(InputStyle style)
    {
    ...
    /// <returns>The builder instance for method chaining.</returns>
    public InputNumberBuilder WithSeparator(bool separator = true)
    {
    ...
    /// <returns>The builder instance for method chaining.</returns>
    public InputNumberBuilder WithIsVisible(bool isVisible)
    {
    ...
    /// <returns>The builder instance for method chaining.</returns>
    public InputNumberBuilder WithHeight(string height)
    {
    ...
    /// <returns>The builder instance for method chaining.</returns>
    public InputNumberBuilder WithFallback(object fallback)
    {
    ...
    /// <returns>The builder instance for method chaining.</returns>
    public InputNumberBuilder WithRequires(string key, string version)
    {
    ...
    /// <returns>The builder instance for method chaining.</returns>
    public InputNumberBuilder WithRtl(bool rtl = true)
    {
        _input.Rtl = rtl;
        return this;
    }
